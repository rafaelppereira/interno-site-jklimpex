  ...
  return (
    <main className=" flex flex-col items-start justify-center fixed right-4 bottom-5 shadow-lg z-[999]">
      ...
      <button
        ...
        className="w-[250px]  hover:brightness-90 transition-all h-12 flex items-center gap-2 justify-start pl-5 bg-primary-500 text-white text-xs font-light mt-[10px] rounded-lg"
      >
        <CaretUp
          size={20}
          color="#FFF"
